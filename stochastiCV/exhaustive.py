...
class StochasticLeavePOutCV:
    ...
    p : int
        Number of datapoints included in test set per run of the model. 
        Set equal to 1 for LeaveOneOut.
    ...
    def fit_predict(self, X, y, X_test=None, y_test=None, threshold=None, stratify=True, verbose=0):
        ...
        stratify : bool (default=True)
            Only used in initial_split, to preserve class proportions.
        verbose : 0, 1, or 2
        ...
        j = 42 # Split_repeat variable, included for compatibility
